...
[^1] A AED é um **conjunto de métodos e ferramentas** que o analista utiliza para **descrever um determinado conjunto de dados**, permitindo compreender o comportamento de diversas variáveis. Permite também solidificar uma base para **criar hipóteses e modelos preditivos/causais**.
